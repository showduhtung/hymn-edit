...
type IndividualVerseFormProps = {
  ...
  onVerseChange: (val: boolean) => void;
};

export const IndividualVerseForm = forwardRef(
  (
    {
      savedVerse,
      originalVerse,
    ...
    function handleUpdateInput(idx: number) {
      return (e: ChangeEvent<HTMLTextAreaElement>) => {
        ...
        setVerse(
          verse.map((line, currIdx) => (currIdx === idx ? value : line))
        );
        setErrors([]);
      };
    }
    ...
    function handleKeydown(idx?: number) {
      ...
      function handleChangeDirection(
        ...
        onVerseChange(event.key === "ArrowRight");
      }
      ...
      return (event: KeyboardEvent<HTMLTextAreaElement>) => {
        ...
        else handleChangeDirection(event);
      };
    }
